...
-- Map <leader>jk to leave Insert/Terminal mode  
vim.keymap.set({'v', 'i'}, '<leader>jk', '<Esc>', {noremap = true, silent = true, desc = "Leave insert mode" })
vim.keymap.set('t', '<leader>jk', '<C-\\><C-n>', {noremap = true, silent = true, desc = "Leave terminal mode" })
